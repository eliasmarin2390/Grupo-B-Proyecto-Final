...
void searchReg()
{
    ...
    for (int i = 0; i < pos; ++i)
    {
        if (items[i].id == id)
        {
            ...
            cout << "Extracto de Chocolate: " << item.extractoChocolate << " litros\n";
            cout << "Extracto de Vainilla: " << item.extractoVainilla << " litros\n";
            cout << "Harina: " << item.harina << " kg\n";
            cout << "Azucar: " << item.azucar << " kg\n";
            cout << "Levadura: " << item.levadura << " kg\n";
            cout << "Dulce de Leche: " << item.dulceLeche << " kg\n";
            cout << "Leche Condensada: " << item.lecheCondensada << " kg\n";
            cout << "Fresa: " << item.fresa << " kg\n";
            cout << "Piña: " << item.pina << " kg\n";
            cout << "Frutos Rojos: " << item.frutosRojos << " kg\n";
            cout << "Leche: " << item.leche << " litros\n";
            cout << "Mantequilla: " << item.mantequilla << " kg\n";
            cout << "Mora: " << item.mora << " kg\n";
            cout << "Cereza: " << item.cereza << " kg\n";
            cout << "Mango: " << item.mango << " kg\n";
            cout << "Chispas de Chocolate: " << item.chispasChocolate << " kg\n";
            cout << "Malvaviscos: " << item.malvaviscos << " unidades\n";
            cout << "Huevos: " << item.huevos << " unidades\n";
            cout << "Empaques: " << item.empaques << " unidades\n";
